...
// ---- Build 6: generated original learning library ----
const EXTRA_BOOK_DEFS = [{"id":"java","title":"Java for Beginners","shortTitle":"Java","symbol":"J","category":"Technology","description":"Learn Java from syntax and OOP to collections, exceptions, testing and practical application structure.","level":"Beginner","kind":"tech","modules":["Java Foundations","Variables, Types & Operators","Control Flow","Methods & Problem Solving","Object-Oriented Programming","Collections & Generics","Exceptions & File Handling","Streams & Modern Java","Testing & Debugging","Build a Java Project"]},{"id":"python","title":"Python for Beginners","shortTitle":"Python","symbol":"Py","category":"Technology","description":"A beginner path through Python syntax, data structures, functions, files, APIs and practical automation.","level":"Beginner","kind":"tech","modules":["Python Foundations","Variables & Data Types","Conditions & Loops","Functions","Lists, Tuples & Dictionaries","Files & Errors","Modules & Packages","APIs & JSON","Automation & Testing","Build a Python Project"]},{"id":"javascript","title":"JavaScript for Beginners","shortTitle":"JavaScript","symbol":"JS","category":"Technology","description":"Understand JavaScript fundamentals, the DOM, events, async code, APIs and browser projects.","level":"Beginner","kind":"tech","modules":["JavaScript Foundations","Values & Variables","Conditions & Loops","Functions & Scope","Arrays & Objects","DOM Basics","Events & Forms","Async JavaScript","APIs & Storage","Build a Web App"]},{"id":"sql","title":"SQL for Beginners","shortTitle":"SQL","symbol":"SQL","category":"Technology","description":"Learn to query, filter, join, aggregate and reason about relational data with practical SQL examples.","level":"Beginner","kind":"tech","modules":["Database Foundations","SELECT & Columns","Filtering & Sorting","Functions & Expressions","Aggregations","GROUP BY & HAVING","Joins","Subqueries & CTEs","Data Changes & Safety","SQL Practice Project"]},{"id":"web-development","title":"Web Development for Beginners","shortTitle":"Web Development","symbol":"</>","category":"Technology","description":"Learn how HTML, CSS and JavaScript work together to create responsive, accessible websites.","level":"Beginner","kind":"tech","modules":["How the Web Works","HTML Foundations","Semantic HTML","CSS Foundations","Layouts & Responsive Design","Forms & Accessibility","JavaScript in the Browser","APIs & Fetch","Performance & SEO Basics","Build and Publish a Site"]},{"id":"git-github","title":"Git & GitHub for Beginners","shortTitle":"Git & GitHub","symbol":"G","category":"Technology","description":"Master commits, branches, merges, pull requests and safe collaboration workflows.","level":"Beginner","kind":"tech","modules":["Version Control Foundations","Repositories & Commits","Branches","Merging","Remotes","GitHub Basics","Pull Requests","Conflicts & Recovery","Team Workflows","Project Practice"]},{"id":"ai-beginners","title":"AI for Beginners","shortTitle":"AI","symbol":"AI","category":"Technology","description":"Understand modern AI, machine learning, generative AI, responsible use and practical everyday applications.","level":"Beginner","kind":"tech","modules":["AI Foundations","Machine Learning Basics","Neural Networks Simply","Generative AI","Language Models","Images & Multimodal AI","AI Tools at Work","Responsible AI","Evaluating AI Answers","Build an AI Workflow"]},{"id":"prompt-engineering","title":"Prompt Engineering for Beginners","shortTitle":"Prompt Engineering","symbol":"✦","category":"Technology","description":"Learn to write clearer AI instructions, provide context, constrain outputs and iterate reliably.","level":"Beginner","kind":"tech","modules":["Prompt Foundations","Goals & Context","Roles & Audience","Constraints & Formats","Examples & Few-Shot Prompting","Reasoning-Friendly Tasks","Editing & Iteration","Prompting for Coding","Prompting for Research","Build Reusable Prompts"]},{"id":"dsa","title":"Data Structures & Algorithms","shortTitle":"DSA","symbol":"D","category":"Technology","description":"A visual, beginner-friendly introduction to arrays, linked structures, trees, graphs and algorithmic thinking.","level":"Beginner","kind":"tech","modules":["Algorithmic Thinking","Complexity Basics","Arrays & Strings","Stacks & Queues","Linked Lists","Hashing","Trees","Graphs","Sorting & Searching","Problem-Solving Practice"]},{"id":"spring-boot","title":"Spring Boot for Beginners","shortTitle":"Spring Boot","symbol":"S","category":"Technology","description":"Build REST APIs with Spring Boot using controllers, services, persistence, validation and testing.","level":"Beginner","kind":"tech","modules":["Spring Boot Foundations","Project Structure","Controllers & REST","Services & Dependency Injection","Configuration","JPA & Databases","Validation & Errors","Security Foundations","Testing","Build a REST Service"]},{"id":"cybersecurity","title":"Cybersecurity for Beginners","shortTitle":"Cybersecurity","symbol":"🛡","category":"Technology","description":"Learn practical security fundamentals: passwords, phishing, web risks, privacy and safer development habits.","level":"Beginner","kind":"tech","modules":["Security Mindset","Accounts & Passwords","Phishing & Social Engineering","Networks & Wi-Fi","Web Security Basics","Malware & Updates","Privacy & Data Protection","Secure Coding Basics","Incident Awareness","Personal Security Plan"]},{"id":"cloud-devops","title":"Cloud & DevOps for Beginners","shortTitle":"Cloud & DevOps","symbol":"☁","category":"Technology","description":"Understand cloud services, containers, CI/CD, monitoring and modern software delivery at a beginner level.","level":"Beginner","kind":"tech","modules":["Cloud Foundations","Compute & Storage","Networking Basics","Containers","Infrastructure as Code","CI/CD","Observability","Reliability","Security & Cost Basics","Deploy a Small App"]},{"id":"communication","title":"Communication Skills for Beginners","shortTitle":"Communication","symbol":"C","category":"Career","description":"Build clearer speaking, listening, writing, feedback and workplace communication habits.","level":"Beginner","kind":"career","modules":["Communication Foundations","Listening Well","Clear Speaking","Asking Better Questions","Workplace Writing","Meetings","Feedback","Difficult Conversations","Cross-Cultural Communication","30-Day Communication Practice"]},{"id":"interview-skills","title":"Interview Skills for Beginners","shortTitle":"Interview Skills","symbol":"I","category":"Career","description":"Prepare stories, answer common questions, handle technical rounds and communicate confidently in interviews.","level":"Beginner","kind":"career","modules":["Interview Foundations","Tell Me About Yourself","Resume-Based Questions","Behavioral Questions","STAR Stories","Technical Interviews","Problem-Solving Out Loud","Questions to Ask","Interview Day","Post-Interview Improvement"]},{"id":"resume-linkedin","title":"Resume & LinkedIn for Beginners","shortTitle":"Resume & LinkedIn","symbol":"R","category":"Career","description":"Create a concise resume and professional profile that communicates skills, achievements and direction clearly.","level":"Beginner","kind":"career","modules":["Career Story","Resume Structure","Writing Strong Bullets","Quantifying Impact","Skills & Keywords","Projects & Experience","LinkedIn Profile","Networking Messages","Tailoring Applications","Application Checklist"]},{"id":"public-speaking","title":"Public Speaking for Beginners","shortTitle":"Public Speaking","symbol":"🎤","category":"Career","description":"Learn to structure talks, manage nerves, use your voice and deliver clear presentations.","level":"Beginner","kind":"career","modules":["Speaking Foundations","Audience & Purpose","Structuring a Talk","Openings & Closings","Voice & Pace","Body Language","Slides & Visuals","Handling Nerves","Questions & Interaction","Deliver a Short Talk"]},{"id":"money-psychology","title":"Money Psychology for Beginners","shortTitle":"Money Psychology","symbol":"₹","category":"Money","description":"An original guide to spending, saving, emotions, biases, goals and healthier financial decision-making.","level":"Beginner","kind":"finance","modules":["Your Relationship With Money","Needs, Wants & Values","Spending Triggers","Saving Behavior","Risk & Uncertainty","Biases & Decisions","Lifestyle Inflation","Goals & Trade-Offs","Money Conversations","Build a Money System"]},{"id":"personal-finance","title":"Personal Finance for Beginners","shortTitle":"Personal Finance","symbol":"₹","category":"Money","description":"Learn budgeting, emergency funds, debt, insurance, investing concepts and long-term money organization.","level":"Beginner","kind":"finance","modules":["Financial Foundations","Cash Flow & Budgeting","Emergency Funds","Debt Basics","Insurance Basics","Banking & Credit","Investing Foundations","Retirement Basics","Taxes & Records","Your Financial Checklist"]},{"id":"habit-building","title":"Habit Building for Beginners","shortTitle":"Habit Building","symbol":"H","category":"Growth","description":"An original habit-building course about cues, routines, environment, consistency and sustainable behavior change.","level":"Beginner","kind":"selfhelp","modules":["How Habits Work","Choose the Right Habit","Make It Small","Design Your Environment","Cues & Triggers","Motivation vs Systems","Tracking Progress","Recover From Missed Days","Breaking Unhelpful Habits","Build a 30-Day System"]},{"id":"productivity-focus","title":"Productivity & Focus for Beginners","shortTitle":"Productivity & Focus","symbol":"P","category":"Growth","description":"Learn practical ways to prioritize, focus, reduce distraction and finish meaningful work without burnout.","level":"Beginner","kind":"selfhelp","modules":["Productivity Foundations","Priorities","Deep Focus","Distraction Control","Task Planning","Energy Management","Procrastination","Digital Boundaries","Review & Reflection","Build Your Weekly System"]},{"id":"time-management","title":"Time Management for Beginners","shortTitle":"Time Management","symbol":"T","category":"Growth","description":"Organize commitments, estimate tasks, protect time and create realistic daily and weekly plans.","level":"Beginner","kind":"selfhelp","modules":["Understand Your Time","Priorities & Trade-Offs","Calendars","Task Lists","Time Blocking","Estimating Work","Saying No","Routines","Weekly Review","Design Your Ideal Week"]},{"id":"nutrition","title":"Nutrition Basics","shortTitle":"Nutrition","symbol":"N","category":"Health","description":"Evidence-based nutrition education covering balanced eating, food groups, labels, hydration and sustainable habits.","level":"Beginner","kind":"health","modules":["Nutrition Foundations","Carbohydrates","Protein","Fats","Fibre & Gut-Friendly Foods","Vitamins & Minerals","Hydration","Food Labels & Portions","Meal Patterns","Build a Balanced Eating Routine"]},{"id":"detox-myths","title":"Detox Myths & Healthy Habits","shortTitle":"Detox Myths","symbol":"D","category":"Health","description":"A safety-first guide explaining detox claims and focusing instead on evidence-based everyday health habits.","level":"Beginner","kind":"health","modules":["What Detox Claims Mean","How the Body Handles Waste","Detox Diet Evidence","Juices & Cleanses","Fasting Claims","Supplements & Teas","Hydration Myths","Food Safety","Healthy Habit Alternatives","Build a Sustainable Routine"]},{"id":"sleep","title":"Sleep Better for Beginners","shortTitle":"Sleep Better","symbol":"Zz","category":"Health","description":"Understand sleep, routines, light, caffeine, stress and practical habits that support better rest.","level":"Beginner","kind":"health","modules":["Sleep Foundations","Your Body Clock","Sleep Pressure","Light & Screens","Caffeine & Alcohol","Bedroom Environment","Stress & Wind-Down","Exercise & Sleep","Common Sleep Problems","Build a Sleep Routine"]},{"id":"fitness","title":"Fitness & Movement for Beginners","shortTitle":"Fitness & Movement","symbol":"F","category":"Health","description":"Start moving safely with walking, strength, mobility, recovery and realistic fitness progression.","level":"Beginner","kind":"health","modules":["Movement Foundations","Walking & Daily Activity","Strength Basics","Mobility","Cardio Basics","Warm-Up & Cool-Down","Progressive Training","Recovery","Consistency","Build a Weekly Routine"]},{"id":"gita","title":"Bhagavad Gita for Everyday Life","shortTitle":"Bhagavad Gita","symbol":"ॐ","category":"Wisdom","description":"An original beginner commentary on major Bhagavad Gita themes such as duty, action, self-knowledge and equanimity.","level":"Beginner","kind":"spiritual","modules":["The Setting & Human Dilemma","Duty and Responsibility","Action Without Clinging","Knowledge and Discernment","The Mind and Self-Mastery","Meditation and Steadiness","Devotion and Trust","Qualities and Choices","Equanimity in Daily Life","Living the Teaching"]},{"id":"meditation","title":"Meditation & Mindfulness for Beginners","shortTitle":"Meditation","symbol":"◉","category":"Wisdom","description":"A practical introduction to attention, breathing, body awareness, emotions and short daily mindfulness practice.","level":"Beginner","kind":"spiritual","modules":["Mindfulness Foundations","Breath Awareness","Body Awareness","Working With Thoughts","Working With Emotions","Everyday Mindfulness","Walking Practice","Compassion","Common Difficulties","Build a Daily Practice"]},{"id":"power-within","title":"The Power Within You","shortTitle":"Power Within","symbol":"★","category":"Wisdom","description":"An original self-development guide to confidence, self-belief, boundaries, resilience and taking constructive action.","level":"Beginner","kind":"selfhelp","modules":["Self-Belief Foundations","Know Your Strengths","Self-Talk","Confidence Through Action","Boundaries","Resilience","Handling Criticism","Courage & Decisions","Personal Values","Your 90-Day Growth Plan"]}];

const PAGE_ANGLES = [
  ['Start here','Understand the core idea before trying to memorize details.'],
  ['Key vocabulary','Learn the small set of words that make this topic easier to discuss and practise.'],
  ['Why it matters','Connect the topic to decisions, real situations and common beginner problems.'],
  ['A simple mental model','Use a clear framework to organize the idea in your head.'],
  ['Step by step','Turn the concept into a sequence you can follow.'],
  ['Worked example','See the idea applied to a realistic beginner scenario.'],
  ['Common mistakes','Notice predictable errors and how to correct them.'],
  ['Practice page','Use the idea actively instead of only reading about it.'],
  ['Questions beginners ask','Review doubts that often appear at this stage.'],
  ['Review and next step','Summarize the module and connect it to what comes next.']
];

function kindCopy(kind, book, module, angle){
  const common = {
    core: `${module} is one part of ${book.title}. On this page, ${angle[1].toLowerCase()} The goal is not to rush; it is to build a usable understanding that you can explain in your own words.`,
    practice: `After reading, write three notes: what you understood, one example, and one question you still have. Then use the AI Tutor to check your explanation or ask for a fresh practice question.`,
    mistake: `A common beginner mistake is trying to remember terminology without connecting it to a real decision or example. Slow down, identify the purpose, then practise one small application.`
  };
  if(kind==='tech') return {...common,
    example:`Imagine you are building or debugging a small application. Ask what input comes in, what transformation happens, what output should appear, and how you would verify it. Apply that thinking to ${module}.`,
    note:`Coding skill grows through small experiments. Change one thing, run it, observe the result, and explain why it changed.`};
  if(kind==='career') return {...common,
    example:`Picture a real workplace situation where you need to communicate your experience clearly. Use ${module} to make the message shorter, more specific and easier for another person to understand.`,
    note:`Practise aloud or in writing. Career skills improve when you rehearse realistic situations, not when you only read advice.`};
  if(kind==='finance') return {...common,
    example:`Use a simple personal-money scenario: income arrives, several choices compete for it, and each choice has a trade-off. Apply ${module} without assuming there is one perfect answer for everyone.`,
    note:`This book is general financial education, not individualized investment, tax, insurance or legal advice. Rules and products can change, so verify current details before acting.`};
  if(kind==='health') return {...common,
    example:`Think about an ordinary daily routine rather than a quick fix. Ask whether the claim is supported by good evidence, whether it is safe, and whether a simpler sustainable habit would achieve the same goal. Apply that lens to ${module}.`,
    note:`This book provides general health education, not diagnosis or treatment. Individual needs vary; seek qualified medical or dietetic advice for symptoms, diseases, pregnancy, medicines or major diet/exercise changes.`};
  if(kind==='spiritual') return {...common,
    example:`Bring ${module} into an everyday situation involving responsibility, emotion, attention or choice. The aim is reflection and practical understanding rather than claiming one compulsory interpretation.`,
    note:`This is original beginner commentary and reflection. It does not reproduce a modern copyrighted translation, and readers may compare multiple respected translations and traditions.`};
  return {...common,
    example:`Choose one ordinary situation from your week and apply ${module} to it. Make the action small enough to try today, then observe what actually happens rather than judging yourself by intention alone.`,
    note:`Personal-growth ideas work best as experiments. Keep what is useful, adapt what is not, and avoid treating any single framework as a universal rule.`};
}

function generatedChapter(book,module,moduleIndex,pageIndex){
  const angle=PAGE_ANGLES[pageIndex];
  const copy=kindCopy(book.kind,book,module,angle);
  const pageNo=moduleIndex*10+pageIndex+1;
  const title=`${module} — ${angle[0]}`;
  return {
    module:`Module ${moduleIndex+1} — ${module}`,
    title,
    intro:`${angle[0]}: ${angle[1]} This is page ${pageNo} of the 100-page ${book.shortTitle} course.`,
    sections:[
      {h:'Core idea',p:[copy.core,`A useful beginner question is: “What problem does ${module} help me understand or solve?” Answer that before collecting more detail.`]},
      {h:'A practical example',p:[copy.example,`Now change one part of the example and predict what should happen. Comparing your prediction with the outcome is an effective way to learn.`]},
      {h:'Common mistake to avoid',p:[copy.mistake,`If the idea still feels vague, reduce it to one sentence and one example. Clarity is more valuable than covering too much at once.`]},
      {h:'Practice for five minutes',p:[copy.practice,`Finish by teaching the idea back in plain language. If you cannot explain it simply yet, reread only the part that blocks you.`]},
      {callout:`Page ${pageNo} takeaway: ${angle[1]} ${copy.note}`}
    ],
    qa:[
      [`What is the goal of this page on ${module}?`,`${angle[1]} You should finish with one clear explanation and one practical example.`],
      ['How should I practise it?','Use a small real or imagined situation, apply the idea, explain your reasoning, and review one mistake or uncertainty.']
    ],
    quiz:{
      q:`Which approach best fits “${title}”?`,
      options:[
        'Understand the purpose, apply it to an example, then practise and review.',
        'Memorize the heading only and avoid examples.',
        'Skip the foundation and jump randomly between advanced topics.'
      ],
      answer:0
    }
  };
...
function buildGeneratedBook(def){
  const book={...def,chapters:[]};
  delete book.modules; delete book.kind;
  def.modules.forEach((module,mi)=>{
    for(let pi=0;pi<10;pi++) book.chapters.push(generatedChapter(def,module,mi,pi));
  });
  book.pageCount=book.chapters.length;
  return book;
}

BOOKS[0].category='Technology';
BOOKS[1].category='Language';
BOOKS.push(...EXTRA_BOOK_DEFS.map(buildGeneratedBook));
